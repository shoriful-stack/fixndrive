  ...
  const handleDelete = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        fetch(`http://localhost:3000/my-bookings/api/booking/${id}`, {
          method: "DELETE",
        })
          .then((res) => res.json())
          .then((data) => {
                        ...
                        <td className="px-2 py-2 text-sm whitespace-nowrap">
                          <div className="flex items-center gap-x-3">
                            ...
                            <Link href={`/my-bookings/update/${_id}`}>
                              <button className="text-gray-500 transition-colors duration-200 dark:hover:text-yellow-500 dark:text-gray-300 hover:text-yellow-500 focus:outline-none cursor-pointer">
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                  fill="none"
                                  viewBox="0 0 24 24"
